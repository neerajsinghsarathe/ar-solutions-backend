...
from .views import FileUploadView, AddDatabase, AddTarget, RemoveTarget, RemoveDatabase, GetAllDatabases, GetAllTargets, GetAllTargetsByDatabase, GetAllFiles, GetAllFilesByTarget
